            ...
            <div class="pull-right">
                <ul class="header-btns">
                    ...
                    <li class="header-account dropdown default-dropdown">
                        ...
                        <a href="profile.php" class="text-uppercase"><?php echo $_SESSION['s_name']; ?></a>

                        <?php } else if(isset($_SESSION['admin_id'])) { ?>

                        <a href="profile.php" class="text-uppercase">Admin</a>
                        ...
                        <ul class="custom-menu">
                            ...
                            <li><a href="profile.php"><i class="fa fa-user-o"></i> My Account</a></li>
                            <li><a href="logout.php"><i class="fa fa-unlock-alt"></i> Logout</a></li>
                            <li><a href="List_customers.php"><i class="fa fa-check"></i> List Users </a></li>
                    ...
                    <li class="header-cart dropdown default-dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                            <div class="header-btns-icon">
                                ...
                                <span class="qty">
                                    <?php
                                    if (!is_null($my_products))
                                        echo sizeof($my_products); 
                                    ?>
                                </span>
                            </div>
                                ...
                                <div class="shopping-cart-list">
                                    ...
                                    <div class="product product-widget">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h5>Quantity <span style="color: #F8694A; font-size: 18px;"><?php echo $nPro[$l]['n_pro']; ?></span></h5>
